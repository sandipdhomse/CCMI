...
infile="/nfs/a245/fbsssdh/CCMI/toz/refC2/toz/UMSLIMCAT/r1i1p1/v2/vmro3_monthly_CESM1-WACCMSD_refC1SD_r1i1p1_197901-201412.nc"
ofile="/nfs/a258/fbsssdh/For_Andreas/partial_CESM1-WACCMSD_refC1SD_r1i1p1_197901-201412.nc"
syear= "1979"
   ...
   for t=0,ntime-1 do begin 
     for i =0,nlat-1 do begin
        for j =0,nlon-1 do begin
            pp=p0*hyam[*]+(hybm[*]*ps[j,i,t])
            app=p0*hyam1[0,*]+(hybm1[0,*]*ps[j,i,t])
            bpp=p0*hyam1[1,*]+(hybm1[1,*]*ps[j,i,t])
            dp=reform(app-bpp)
           COLFAC=2.132E20
            alat=lats[i]
            ylim=170.
...
;   spawn,'cdo -f nc copy '+ofile+' '+nfile+''
endfor
end
